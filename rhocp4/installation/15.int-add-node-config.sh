...
mkdir -p ${CONFIG_DIR}/add-nodes
NODE_CONFIG_FILE="${CONFIG_DIR}/add-nodes/nodes-config.yaml"
...
for node in "${ADD_NODE_INFO_LIST[@]}" 
do
...
echo "Success: $NODE_CONFIG_FILE has been generated."